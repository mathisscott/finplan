...
export const meta: MetaFunction = () => {
  return [
    { title: 'Financial Planner' },
    {
      name: 'description',
      content:
        'Be in control of your finances with the Financial Planner - the buzzworthy expense and income tracker with a modern interface. Keep your finances organized!',
    },
  ];
};
