...
function Component() {
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "w-full", children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(H1, { children: "Your income" }, void 0, false, {
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "mt-10 w-full flex flex-col-reverse lg:flex-row", children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("section", { className: "lg:p-8 w-full lg:max-w-2xl", children: [
        /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("h2", { className: "sr-only", children: "All your income" }, void 0, false, {
          fileName: "app/routes/dashboard.income.tsx",
          lineNumber: 63,
          columnNumber: 11
        }, this),
        ...
        /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("ul", { className: "flex flex-col", children: invoices.map((invoice) => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(ListLinkItem, { to: `/dashboard/income/${invoice.id}`, isActive: invoice.id === id, deleteProps: {
          ariaLabel: `Delete invoice ${invoice.title}`,
          action: `/dashboard/income/${invoice.id}?index`
        }, children: [
          /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("p", { children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("i", { children: new Date(invoice.createdAt).toLocaleDateString("en-US") }, void 0, false, {
            fileName: "app/routes/dashboard.income.tsx",
            lineNumber: 73,
            columnNumber: 19
          }, this) }, void 0, false, {
          ...
          /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("p", { className: "text-xl font-semibold", children: invoice.title }, void 0, false, {
            fileName: "app/routes/dashboard.income.tsx",
            lineNumber: 75,
            columnNumber: 17
          }, this),
          ...
          }).format(invoice.amount) }, void 0, false, {
            fileName: "app/routes/dashboard.income.tsx",
            lineNumber: 77,
            columnNumber: 19
          }, this) }, void 0, false, {
...
//# sourceMappingURL=/build/routes/dashboard.income-I6XSSPMC.js.map
