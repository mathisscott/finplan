...
if (!window.$RefreshReg$ || !window.$RefreshSig$ || !window.$RefreshRuntime$) {
  ...
  window.$RefreshReg$ = (type, id) => {
    window.$RefreshRuntime$.register(type, '"app/routes/dashboard.income._index.tsx"' + id);
  };
...
function Component() {
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Form, { method: "POST", action: "/dashboard/income/?index", encType: "multipart/form-data", children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Input, { label: "Title:", type: "text", name: "title", placeholder: "Salary December 2022", required: true }, void 0, false, {
...
//# sourceMappingURL=/build/routes/dashboard.income._index-MMD6XNZG.js.map
